...
console.log('1️⃣  Generating OpenAPI spec from API Zod schemas...');
try {
...
console.log('2️⃣  Generating TypeScript types from OpenAPI spec...');
...
console.log('3️⃣  Adding header and helper types...');
...
console.log('   ✅ Header and helpers added\n');

// Step 4: Copy to Dashboard
console.log('4️⃣  Copying types to Dashboard...');
...
console.log(`   ✅ Dashboard types updated: ${dashboardTypesPath}\n`);

// Step 5: Copy to Widget
console.log('5️⃣  Copying types to Widget...');
...
console.log(`   ✅ Widget types updated: ${widgetTypesPath}\n`);

// Step 6: Generate checksum for validation
console.log('6️⃣  Generating checksum...');
...
console.log(`   ✅ Checksum saved: ${checksum.substring(0, 12)}...\n`);
...
console.log(`📦 Generated Types: ${typesOutput}`);
console.log(`🎨 Dashboard: ${dashboardTypesPath}`);
console.log(`🎯 Widget: ${widgetTypesPath}`);
console.log(`✅ Checksum: ${checksum.substring(0, 12)}...`);
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
console.log('⚠️  Remember to commit the updated type files!');
